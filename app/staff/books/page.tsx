// TODO: LEGACY SURFACE — /staff/books
// This route is a legacy entry point for the editorial staff books interface.
    ...
    <div className="p-6 lg:p-8 space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Editorial book projects — legacy staff view
        </p>
      </div>
      ...
      <Card className="border-amber-200 bg-amber-50 dark:bg-amber-950/20 dark:border-amber-800">
        ...
        <CardContent className="space-y-3">
          <p className="text-sm text-amber-700 dark:text-amber-300">
            ...
            book projects has moved to the company-first route.
          </p>
          <Button asChild variant="outline" size="sm">
            <Link href="/app/companies/reino-editorial/projects">
              Go to Reino Editorial Projects →
            </Link>
          </Button>
        </CardContent>
      </Card>
