...
const UNITS: BusinessUnit[] = [
  {
    ...
    logoBg: `linear-gradient(135deg, ${P.burgundy}, ${P.navyLight})`,
    logoRounded: true,
  ...
  },
  {
    ...
    logoBg: "linear-gradient(135deg, #1a1a1a, #333333)",
    logoRounded: false,
  ...
  },
  {
    ...
    logoBg: `linear-gradient(135deg, ${P.navy}, ${P.navyLight})`,
    logoRounded: true,
  ...
  },
  {
    ...
    logoBg: "linear-gradient(135deg, #e8710a, #c45e08)",
    logoRounded: false,
  ...
  },
  {
    ...
    logoBg: `linear-gradient(135deg, ${P.gold}, ${P.goldLight})`,
    logoRounded: true,
